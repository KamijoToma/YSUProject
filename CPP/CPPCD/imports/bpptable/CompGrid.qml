...
Item {
    ...
    property string icoCopy: "📋"
    property string ttCopy: qsTr("Copy current row")
    property string icoOptions: "BppTable/assets/cog-solid.svg"
    property string ttOptions: qsTr("Options")
    property string icoCancel: "BppTable/assets/icon-delete.svg"
    ...
    Rectangle {
                ...
                Repeater {
                    ...
                    Rectangle{
                        ...
                        Text {
                            ...
                            text: headingCell.sortIndicator === 1 ? "↑" : "↓"
                            width: 10; height: 10
                        }
                        ColorOverlay{
        ...
        Rectangle {
            ...
            Text {
                text: columnSorter.currentSortValue === 0 ? "↕" :
                                                              (columnSorter.currentSortValue === 1 ? "↑" : "↓")
                anchors.centerIn: parent
            }
